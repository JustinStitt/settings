...
let g:airline#themes#undead#palette.visual =
...
let g:airline#themes#undead#palette.inactive =
airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

let g:airline#themes#undead#palette.normal.airline_warning =   [ '#ff00ff' ,
'#ff00ff' , 0 , 1 , '' ]
let g:airline#themes#undead#palette.insert.airline_warning =   [ '#ff00ff' ,
'#ff00ff' , 0 , 1 , '' ]
let g:airline#themes#undead#palette.visual.airline_warning =   [ '#ff00ff' ,
'#ff00ff' , 0 , 1 , '' ]
let g:airline#themes#undead#palette.replace.airline_warning =  [ '#ff00ff' ,
'#ff00ff' , 0 , 1 , '' ]
